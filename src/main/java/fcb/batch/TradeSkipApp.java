...
public class TradeSkipApp {
	private final Logger logger = LoggerFactory.getLogger(this.getClass());
	
	public static void main(String[] args) {
		TradeSkipApp app = new TradeSkipApp();
		app.run();
	}
	...
	private void run() {
		...
		try (ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("spring/batch/jobs/job-trade-skip.xml")) {
			...
			Job job = (Job) context.getBean("tradeSkipJob");
